...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN] = LAYOUT_65_ansi(
        ...
        KC_TRNS, KC_LGUI, KC_LALT,                   KC_TRNS,                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
    [_FN] = LAYOUT_65_ansi(
        KC_GRV,    KC_F1,    KC_F2,    KC_F3,    KC_F4,   KC_F5,    KC_F6,   KC_F7, KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NO,   SLEEPY,
        KC_NO,     KC_MUTE,  KC_VOLU,  KC_NO,    KC_NO,   KC_NO,    KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_HOME,
        KC_CAPS,   KC_MPRV,  KC_VOLD,  KC_MNXT,  KC_NO,   KC_NO,    KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NO,   KC_END,
        KC_TRNS,   TO(_MAC), TO(_WIN), KC_NO,    KC_NO,   KC_NO,    KC_NO,   KC_NO, KC_NO,   QK_BOOT, KC_NO,            KC_NO,   RGB_VAI, KC_NO,
        KC_TRNS,   KC_TRNS,  KC_TRNS,                     KC_MPLY,                           KC_TRNS, KC_NO,   KC_TRNS, KC_NO,   RGB_VAD, KC_NO
    )
};
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    if (get_highest_layer(layer_state) == _FN) {
        ...
        rgb_matrix_set_color(45, 100, 180, 200);
        rgb_matrix_set_color(46, 100, 180, 200);
